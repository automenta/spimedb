...
(function ($$) {
    ...
    var findClippingPoint = function (node, dX, dY) {
        ...
        const nodeSlope = H / W;
        //const dirSlopeLess = dirSlope <= nodeSlope;
        ...
        else if (0 < dX && -1 * nodeSlope <= dirSlope && dirSlope <= nodeSlope) {
    ...
    var calculateEdgeForces = function (layoutInfo, cy, options) {
        ...
        for (var i = 0; i < layoutInfo.edgeSize; i++) {
            ...
            var lx = point2[0] - point1[0];
            var ly = point2[1] - point1[1];
            var l = Math.sqrt(lx * lx + ly * ly);

            const eil = (edge.idealLength - l);
            var force = eil*eil / options.edgeElasticity;
