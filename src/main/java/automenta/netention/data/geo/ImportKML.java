...
//
//    public void transformKML(String layer, String urlString, InfiniPeer st, final GISVisitor visitor) throws Exception {
...
//    }
//
//    public ImportKML(InfiniPeer st, Proxy proxy, String id, String url) {
//        this.st = st;
//        this.proxy = proxy;
//        this.id = id;
//        this.url = url;
