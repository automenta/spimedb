...
package automenta.netention.gui.browser.navigation;
...
public class NavTools {
    ...
    public static Pane createNavPane(final WebBrowser chrome) {
        ...
        GlyphsDude.setIcon(backButton, FontAwesomeIcon.BACKWARD);
...
//        backColorAdjust.setContrast(-0.1);
        ...
        GlyphsDude.setIcon(backButton, FontAwesomeIcon.FORWARD);
