...
//        }
    ...
    public V getEdgeSource(E e) {
        return getIntrusiveEdge(e).getOne();
    }
    ...
    public V getEdgeTarget(E e) {
        return getIntrusiveEdge(e).getTwo();
    }

    private Pair<V, V> getIntrusiveEdge(E e) {
        return edges.get(e);
    }
...
//        ((DefaultWeightedEdge) e).weight = weight;
     ...
     */
    private VertexContainer<C, E> getEdgeContainer(V vertex, C value) {
    ...
    private VertexContainer<C, E> getEdgeContainer(V vertex) {
        return getEdgeContainer(vertex, null);
    }
