...
package automenta.netention.net.gossip.configuration;

import automenta.netention.net.gossip.Gossip;
import automenta.netention.net.gossip.SystemView;
import automenta.netention.net.gossip.UdpCommunications;
...
public class GossipConfiguration {
    ...
    public int                     cleanupCycles           = Gossip.DEFAULT_CLEANUP_CYCLES;
    ...
    public int                     heartbeatCycle          = Gossip.DEFAULT_HEARTBEAT_CYCLE;
    public String                  hmac;
