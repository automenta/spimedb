...
public interface IWebdavStore {
     ...
     */
    ITransaction start(Principal principal);
     ...
     *      transaction
     */
    void authenticate(ITransaction transaction);
     ...
     *      if something goes wrong on the store level
     */
    void newFolder(ITransaction transaction, String folderUri);
     ...
     *      if something goes wrong on the store level
     */
    void newResource(ITransaction transaction, String resourceUri);
     ...
     *      if something goes wrong on the store level
     */
    InputStream stream(ITransaction transaction, String resourceUri);
     ...
     * @return StoredObject
     */
    StoredObject get(ITransaction transaction, String uri);
     ...
     *      if something goes wrong on the store level
     */
    long put(ITransaction transaction, String resourceUri,
     ...
     *      if something goes wrong on the store level
     */
    String[] in(ITransaction transaction, String folderUri);
     ...
     *      if something goes wrong on the store level
     */
    long size(ITransaction transaction, String resourceUri);
     ...
     *      if something goes wrong on the store level
     */
    void remove(ITransaction transaction, String uri);
