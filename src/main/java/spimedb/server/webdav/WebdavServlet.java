...
public class WebdavServlet extends WebDavServletBean {
    ...
    public static PathHandler get(String path) throws ServletException {
        DeploymentInfo servletBuilder = Servlets.deployment()
                .setClassLoader(WebdavServlet.class.getClassLoader())
                .setContextPath(path)
                .setDeploymentName("test.war")
                .addServlets(
                        Servlets.servlet("WebDAV", WebdavServlet.class)
        ...
        //return Handlers.path(manager.start());

        return Handlers.path(Handlers.redirect(path)).addPrefixPath(path, manager.start());
    }
    ...
    public void init() throws ServletException {
        ...
        File root = new File("/tmp"); //getFileRoot();
    ...
    protected static IWebdavStore constructStore(String clazzName, File root) {
