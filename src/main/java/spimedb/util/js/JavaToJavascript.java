...
//        this(new ClasspathClassHolderSource(), new MapProgramCache(new ConcurrentHashMap<>())
...
//    }
    ...
    public JavaToJavascript(ClasspathClassHolderSource chs, ProgramCache programCache) {
        JavaScriptTarget tgt = new JavaScriptTarget();
        tgt.setMinifying(false);
        //tgt.setAstCache();
    ...
    public String compile(String entryFunc, MethodReference method) {
...
//        System.out.println(t.getWrittenClasses().getClassNames());
    ...
    public String compileMain(Class c) {
...
//                    InstructionIterator instructions = block.iterateInstructions();
