                ...
                _.map(rr, (x) => {
                    ...
                    if (x.icon) {
                        const tt =
                                ...
                                S.E('img').attr('src', itemURL(I, 'icon'))
                            //)
                        ;
                        y.append(
                            tt
                    ...
                    if (x['_']) {
                        y.append(S.E('p').attr('class', 'textpreview').html(x['_'].replace('\n', '<br/>')));
                    }
