...
public class DoGet extends DoHead {
    ...
    protected void doBody(ITransaction transaction, HttpServletResponse resp,
        ...
        try {
            ...
            InputStream in = _store.stream(transaction, path);
            try {
                int read = -1;
        ...
        if (so == null) {
            ...
            if (so.isFolder()) {
                ...
                for (String child : children) {
                    ...
                    StoredObject obj= _store.get(transaction, path+ '/' +child);
     ...
     */
    protected static DateFormat getDateTimeFormat(Locale browserLocale)
    {
     ...
     */
    protected static String getHeader(ITransaction transaction, String path,
                                      HttpServletResponse resp, HttpServletRequest req)
    {
     ...
     */
    protected static String getFooter(ITransaction transaction, String path,
                                      HttpServletResponse resp, HttpServletRequest req)
    {
        return "";
    }
